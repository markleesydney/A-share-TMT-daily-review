...
占全市场 {num(c["share_now"],2)}%（60日 {num(c["share_pctile_60d"],1)} 分位）</div></div>''')
    ...
    p.append(f'<div class="note"><b>一句话概括：</b>'
             ...
             f'8/19收盘全线重挫：30年期美债5.33%创2007年新高（10Y 4.85%）+OpenAI Q2营收放缓+费城半导体-4.98%（SK海力士/闪迪跌超9%）+韩国KOSPI跌超5%，'
             f'A股三大指数集体重挫（沪指-2.40%失守3900/创业板-6.26%/科创50-6.89%），半导体-7.57%/CPO-8.37%领跌，超5000股下跌/130家跌停，煤炭/银行/厨卫电器逆势。'
